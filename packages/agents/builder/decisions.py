...
def pick_bounty(*, bounties: list[dict[str, Any]], skills: list[str]) -> dict[str, Any] | None:
    ...
    if api_key := os.environ.get("ANTHROPIC_API_KEY"):
        try:
            return _pick_via_anthropic(bounties=bounties, skills=skills, api_key=api_key)
        except Exception:
            pass  # fall back to scoring
